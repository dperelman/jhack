...
public class PSIEditor extends EbHackModule implements ActionListener
{
    ...
    //GUI components
    private JComboBox PSISel, nameSel, letterSel, typeSel, animSel, hPosSel, vPosSel;
    private AutoSearchBox letterBox, hPosBox;
    private JTextField nessLevelBox, paulaLevelBox, pooLevelBox, nameBox, titleBox;
...
//      nameSel.setEditable(true);
        entry.add(pairComponents(getLabeledComponent("Name:", nameSel), nameBox,
        		true, true, "Name Selector", "Name Box"));
    ...
    public void actionPerformed(ActionEvent ae)
    {
        ...
        {
        	nameBox.setText(nameSel.getItemAt(nameSel.getSelectedIndex()).toString());
        }
   }
 ...
 /*  EC	   ASB	    C    C	   AE		TF	          TF	  TF	    ASB   C	    TE
     name, letter, type, anim, action, nessLevel, paulaLevel, pooLevel, hPos, vPos, helpAdd
     */
        psis[i].setName(nameSel.getSelectedIndex() + 1);        
        psis[i].setLetter(Integer.parseInt(letterBox.getText()));
        if ((typeSel.getSelectedIndex() == 0) || (typeSel.getSelectedIndex() == 1))
    ...
    public static class PSI
    {
        ...
        /**
         * Greek letter of the PSI(1 = alpha, 2 = beta, 3 = gamma, 4 = sigma, 5 = omega)
         *
         */
        private int letter;

        /**
         * Gets Greek letter of the PSI(1 = alpha, 2 = beta, 3 = gamma, 4 = sigma, 5 = omega)
         *
         */
        ...
        /**
         * Sets Greek letter of the PSI(1 = alpha, 2 = beta, 3 = gamma, 4 = sigma, 5 = omega)
         *
         */
