    ...
    PropertyChangeListener, MouseListener, AdjustmentListener
{
    ...
    public void actionPerformed(ActionEvent e)
    {
        ...
        else if (type.equals("T"))
        {
            if (DEBUG)
                System.out
                    .println("A top buttons action: " + name.substring(1));
        }
    }
    ...
    public class MapGraphics extends AbstractButton
    {
        ...
        private Image[][][] tile_images = new Image[TILESET_NAMES.length][1024][8];
            ...
            else if (this.modeprops[this.mode][1] == 2)
            {
                ...
                for (int i = 0; i < maparray.length; i++)
                {
                    ...
                    for (int i2 = 0; i2 < row2draw.length; i2++)
                    {
                        ...
                        tile_pal = tsetPal[1]; // TileEditor.tilesets[mapcontrol.getDrawTileset(tsetPal[0])].getPaletteNum(tsetPal[0],
                        // tsetPal[1]);
                         ...
                         */
                        g.drawImage(tile_images[tile_set][tile_tile][tile_pal],
    ...
    public static class EbMap
    {
        ...
        public int[] getTiles(int row, int start, int length)
        {
            ...
            for (int i = 0; i < output.length; i++)
            {
                ...
                if (read_byte == -1)
                {
                    System.err.println("Error in getTiles at address "
                        + address);
                }
                else
                {
