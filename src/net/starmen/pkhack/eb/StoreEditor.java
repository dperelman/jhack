...
/**
 * Editor for what items are sold in what stores. Requires ItemEditor because
 * it shows the item names and allows editing of their costs.
 * 
 * @author AnyoneEB
 * @see ItemEditor
 */
public class StoreEditor extends EbHackModule implements ActionListener
{
     ...
     * @see #storeNames
     */
    public static final int NUM_STORES = 65;
    /**
    ...
    private void showInfo(int i)
    {
        ...
        for (int j = 0; j < item.length; j++)
        {
            ...
            money[j].setText(
                Integer.toString(
                    ItemEditor.items[item[j].getSelectedIndex()].cost));
        }
    }
    private void saveInfo(int i)
    {
        ...
        for (int j = 0; j < item.length; j++)
        {
            ...
            ItemEditor.items[item[j].getSelectedIndex()].cost =
                Integer.parseInt(money[j].getText());
    ...
    public static class Store
    {
        ...
        /**
         * Gets the item number of the <code>i</code> 'th item in this
         * store's list.
         * 
        ...
        /**
         * Sets the item number of the <code>i</code> 'th item in this
         * store's list.
         * 
